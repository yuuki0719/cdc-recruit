...
export default function Footer() {
  return (
    <footer>
      <Link  href="/"  className="bg-[#00A0E8] text-[65px] my-[60px] text-white text-center px-[60px] py-[50px] block mx-[5%] md:mx-[20%] md:my[120px] font-bold">Entry</Link>
      <div className="flex justify-between mx-[15px] mt-[60px]">
        ...
        <Link href="#" className="flex justify-end mr-[15px] mt-auto scroll-smooth">
