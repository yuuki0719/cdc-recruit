...
<<<<<<< HEAD
        <div className="w-[100%] h-auto relative ">
          ...
          <div className=" skew-y-[-6deg] origin-top-left">
            <div className="w-[100%]  py-[20px] text-center text-[28px] md:text-[45px] lg:text-[55px] font-bold bg-[#00A0E8] absolute   translate-x-[-50%] translate-y-[-50%] animate-slide-in-blurred-left">
              貫き続ける覚悟はあるか
            </div>
          </div>
        </div>
