  ...
  return (
    <body>
      ...
      <div className="mx-[25px] mb-[39px]">
        ...
        <h3 className="md:text-[20px]">{interview[1].h3[0]}</h3>
      </div>
      ...
      <div className="mx-[25px] mb-[39px] ">
        ...
        <h3 className="md:text-[20px]">{interview[1].h3[1]}</h3>
      </div>
      <div className="px-12 space-y-10 my-[60px] ">
      ...
      <div className="mx-[25px]  mb-[39px]">
        ...
        <h3 className="md:text-[20px]">{interview[1].h3[2]}</h3>
      </div>
      <div className="px-12 space-y-10 my-[60px] ">
=======
...
<body>
    <Header />
    <Image src={interview[1].mein} width={1560} height={1040} alt={interview[1].alt } className="w-[100%]" />
    <div className='px-12 space-y-10 my-[60px] '>
        <p className=''>{interview[1].p_1}</p>
    </div>
    <Image src={interview[1].images[0]} width={5568} height={3712} alt={interview[1].alt} />
    <div className='mx-[25px] mb-[39px]'>
    <h2 className='mb-[30px] text-[20px] md:text-[30px]'>{interview[1].h2[0]}</h2>
    <h3 className='md:text-[20px]'>{interview[1].h3[0]}</h3>
    </div>
    <div className='px-12 space-y-10 mb-[60px] '>
        <p>{interview[1].p_2[0]}</p>
    ...
    <div className='mx-[25px] mb-[39px] '>
    <h2  className='mb-[30px] text-[20px] md:text-[30px]'>{interview[1].h2[1]}</h2>
    <h3 className='md:text-[20px]'>{interview[1].h3[1]}</h3>
    </div>
    <div className='px-12 space-y-10 my-[60px] '>
        <p className='mt-[30px]'>{interview[1].p_3[0]}</p>
    ...
    <Image src={interview[1].images[1]} width={5568} height={3712} alt={interview[0].alt} />
    <div className='mx-[25px]  mb-[39px]'>
    <h2 className='mb-[30px] text-[20px] md:text-[30px]'>{interview[1].h2[2]}</h2>
    <h3 className='md:text-[20px]'>{interview[1].h3[2]}</h3>
    </div>
    <div className='px-12 space-y-10 my-[60px] '>
...
<<<<<<< HEAD
      ...
      <div className="mx-[25px]  mb-[39px]">
        ...
        <h3 className="md:text-[20px]">{interview[1].h3[3]}</h3>
      </div>
      <div className="px-12 space-y-10 my-[60px] ">
      ...
      <h1 className="text-center text-[30px] my-[60px] font-bold">
        {interview[1].footer_h1}
      </h1>
      <Splide
=======
    </div>
    <div className='mx-[25px]  mb-[39px]'>
    <h2 className='mb-[30px] text-[20px] md:text-[30px]'>{interview[1].h2[3]}</h2>
    <h3 className='md:text-[20px]'>{interview[1].h3[3]}</h3>
    </div>
    <div className='px-12 space-y-10 my-[60px] '>
        <p>{interview[1].p_5[0]}</p>
    ...
    <h1 className='text-center text-[30px] my-[60px] font-bold'>{interview[1].footer_h1}</h1>
    <Splide
>>>>>>> ff628ef57ec185a711ddcd11e63b4c8e28976a3b
        className=""
        options={{
